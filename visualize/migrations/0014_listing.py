    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scrape_id', models.DecimalField(decimal_places=0, max_digits=20)),
                ('last_scraped', models.DateField()),
                ('name', models.CharField(max_length=400)),
                ('summary', models.CharField(max_length=10000)),
                ('space', models.CharField(max_length=4000)),
                ('description', models.CharField(max_length=10000)),
                ('experiences_offered', models.CharField(max_length=4000)),
                ('neighborhood_overview', models.CharField(max_length=4000)),
                ...
                ('host_response_rate', models.CharField(max_length=3)),
                ('host_acceptance_rate', models.IntegerField()),
                ('host_is_superhost', models.IntegerField()),
                ...
                ('jurisdiction_names', models.CharField(max_length=40)),
